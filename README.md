...
```bash
helm install --create-namespace -n magento2-demo magento2 oci://registry-1.docker.io/nholuongut/magento --version 2.7.0
```
...
dependencies:
  - name: magento
    version: 2.7.0
    repository: oci://registry-1.docker.io/nholuongut
```

## Magento2 base image
The chart references [Nho Luong ](https://github.com/nholuongut/nholuong) Magento2 Docker image. It consists of an
[Alpine nginx+PHP8.2 base image](https://github.com/nholuongut/docker-nginx-php.git), [Magento OpenSource 2.4.6-p4 source code](https://github.com/magento/magento2)
...
## SMTP server
supervisord starts a simple Postfix MTA included in the [Alpine base image](https://github.com/nholuongut/docker-nginx-php.git).
...
#### Disclaimer
This guide and the `values_docker.yaml` file are configured for the *magento.local* domain. You will need to update a few lines on the said file as shown in [this section](https://github.com/nholuongut/magento2-helm#updating-domains-magento_cloud_-variables-and-values-files)
...
#### Disclaimer
This guide and the `values_gke.yaml` file are configured for the *magento.nholuongut.rocks* example domain. You will need to update a few lines as described in [this section](https://github.com/nholuongut/magento2-helm#updating-domains-magento_cloud_-variables-and-values-files).
